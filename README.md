...
### Planning:
We first decided to create a museum mapper app as a group. We took our time to plan out the front-end and backend in pseudocode so we could build out these parts of the App successfully when it came to coding these parts. I used Figma to develop wireframes after deciding on the basis for the App. After I finished the wireframes, we used Asana to determine which tasks needed to be performed and who would be in charge of completing them. 
